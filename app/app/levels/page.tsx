            ...
            {levels.map((level, index) => (
                <div key={level.id} className="relative pl-12">
                    ...
                    <div className={cn(
                        ...
                        Number(profile?.level_id) === Number(level.id) ? "bg-cyan-500 border-cyan-500/30 shadow-[0_0_20px_rgba(6,182,212,0.5)]" : "bg-zinc-900 border-white/5"
                    )}>
                        {Number(profile?.level_id) === Number(level.id) && <div className="w-1.5 h-1.5 bg-white rounded-full animate-ping" />}
                    </div>
                    ...
                    <div className={cn(
                        ...
                        Number(profile?.level_id) === Number(level.id) ? "border-cyan-500/20 bg-cyan-500/[0.02]" : ""
                    )}>
